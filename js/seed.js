...
AIM.seed = function () {
  ...
  const people = [
    ...
    P('p02', 'Đặng Ngọc Khánh', 'Phó Trưởng Ban Kiểm soát Nội bộ kiêm Trưởng phòng Kiểm toán nội bộ, Người phụ trách Kiểm toán nội bộ', 'Phòng Kiểm toán nội bộ', 'Tài chính', 1),
    P('p03', 'Vũ Anh Quân', 'Phó Trưởng Ban Kiểm soát Nội bộ kiêm trưởng phòng Phân tích và kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kế hoạch, quản lý dự án', 1),
    P('p04', 'Văn Kim Hoàng', 'Phó Trưởng Ban kiêm Trưởng Phòng Tổng hợp, thực hiện nhiệm vụ Thư ký HĐTV', 'Phòng Tổng hợp', 'Tổng hợp', true),
    P('p05', 'Lý Quốc Đạt', 'Chuyên viên Phân tích', 'Phòng Phân tích và Kiểm soát rủi ro', 'Pháp lý'),
    P('p06', 'Đoàn Thái Việt', 'Phó trưởng phòng Kiểm toán Nội bộ', 'Phòng Kiểm toán nội bộ', 'Kiểm toán'),
    P('p07', 'Ngô Thị Tuấn Anh', 'Chuyên viên Kiểm toán nội bộ', 'Phòng Kiểm toán nội bộ', 'Tài chính'),
    P('p08', 'Nguyễn Văn Điều', 'Chuyên viên Kiểm toán nội bộ', 'Phòng Kiểm toán nội bộ', 'Đầu tư'),
    P('p09', 'Lê Thùy Dương', 'Phó Trưởng phòng Phân tích và kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Tài chính'),
    P('p10', 'Nguyễn Thị Hải Yến', 'Phó Trưởng phòng Phân tích và kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kế hoạch, quản lý dự án'),
    P('p11', 'Trần Ngọc Ánh', 'Chuyên viên Phân tích', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kế hoạch, quản lý dự án'),
    P('p12', 'Vũ Thúy Quỳnh', 'Chuyên viên Phân tích', 'Phòng Phân tích và Kiểm soát rủi ro', 'Thương mại'),
    P('p14', 'Nguyễn Bá Minh', 'Kỹ sư Phân tích Kỹ thuật', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kỹ thuật'),
    P('p15', 'Trần Phương Anh', 'Chuyên viên Kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kiểm toán'),
    P('p16', 'Nguyễn Bá Lập', 'Chuyên viên Kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Kế toán'),
    P('p17', 'Giang Anh Dũng', 'Chuyên viên Kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Tài chính'),
    P('p18', 'Chu Nhật Anh', 'Chuyên viên Kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Quản trị rủi ro'),
    P('p19', 'Trần Bảo Châu', 'Chuyên viên Kiểm soát rủi ro', 'Phòng Phân tích và Kiểm soát rủi ro', 'Thương mại'),
    P('p20', 'Vũ Ái Ngọc Bình', 'Chuyên viên Phân tích', 'Phòng Phân tích và Kiểm soát rủi ro', 'Pháp lý'),
    P('p21', 'Nguyễn Mỹ Hạnh', 'Chuyên viên Tổng hợp, Thư ký giúp việc HĐTV', 'Phòng Tổng hợp', 'Tổng hợp'),
    P('p22', 'Nguyễn Minh Hằng', 'Chuyên viên Tổng hợp, Thư ký giúp việc HĐTV', 'Phòng Tổng hợp', 'Tổng hợp'),
    P('p23', 'Nguyễn Thị Phương Anh', 'Chuyên viên Tổng hợp, Thư ký giúp việc HĐTV', 'Phòng Tổng hợp', 'Tổng hợp'),
    P('p24', 'Lương Lê Thu Hằng', 'Thư ký Chủ tịch HĐTV', 'Phòng Tổng hợp', 'Tổng hợp'),
    P('p25', 'Phùng Đình Sơn', 'Chuyên viên Tổng hợp, Thư ký giúp việc HĐTV', 'Phòng Tổng hợp', 'Tổng hợp')
  ];
